...
function InsertLight(position, color, intensity, constAtt, linearAtt, quadAtt, enabled, lightNum)
    setBuffer("Froxels::positions", lightNum*16, "VEC4", position)
    setBuffer("Froxels::colors", lightNum*16, "VEC4", color)
    setBuffer("Froxels::intensities", lightNum*4, "FLOAT", intensity)
    setBuffer("Froxels::constAtt", lightNum*4, "FLOAT", constAtt)
    setBuffer("Froxels::linearAtt", lightNum*4, "FLOAT", linearAtt)
    setBuffer("Froxels::quadAtt", lightNum*4, "FLOAT", quadAtt)
    setBuffer("Froxels::enableds", lightNum*4, "BOOL", enabled)
end
